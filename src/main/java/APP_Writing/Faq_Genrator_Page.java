...
public class Faq_Genrator_Page {
WebDriver driver;
public Faq_Genrator_Page(WebDriver driver) {
	this.driver=driver;
...
@FindBy(xpath="//a[@href='/faq-generator']")
WebElement faq_generator;
...
public void FAq() throws Exception {
	...
	company_name.sendKeys("j c Info tech");
