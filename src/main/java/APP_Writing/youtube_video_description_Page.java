...
public class youtube_video_description_Page {
WebDriver driver;
public youtube_video_description_Page(WebDriver driver) {
	this.driver=driver;
...
@FindBy(xpath="//a[@href='/youtube-video-description']")
WebElement youtube_video_description;
...
public void youtube_video() throws Exception {
driver.manage().timeouts().implicitlyWait(20,TimeUnit.SECONDS);
	
	Writing.click();
	String tex=Writing_Assistant.getText();
	System.out.println(tex);
	youtube_video_description.click();
