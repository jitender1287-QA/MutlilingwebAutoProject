...
public class Story_generator_Page {
WebDriver driver;

public Story_generator_Page(WebDriver driver) {
	this.driver=driver;
...
@FindBy(xpath="//a[@href='/story-generator']")
WebElement story_generator;
@FindBy(xpath="//select[@id='story_type']")
WebElement story_type;
...
public void story_genrator() throws Exception {
	...
	story_generator.click();
	Select sel0= new Select(story_type);
	sel0.selectByVisibleText("Fantasy");
