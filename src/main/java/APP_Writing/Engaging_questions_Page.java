...
public class Engaging_questions_Page {
WebDriver driver;
public Engaging_questions_Page(WebDriver driver) {
	this.driver=driver;
...
@FindBy(xpath="//a[@href='/engaging-questions']")
WebElement engaging_questions;
...
public void Engging_q() throws Exception {
driver.manage().timeouts().implicitlyWait(20,TimeUnit.SECONDS);
	
	Writing.click();
	String tex=Writing_Assistant.getText();
	System.out.println(tex);
	engaging_questions.click();
