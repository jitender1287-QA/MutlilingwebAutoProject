...
public class Compare_Product_Service_Page {
WebDriver driver;
public Compare_Product_Service_Page(WebDriver driver) {
	this.driver=driver;
...
@FindBy(xpath="//a[@href='/compare-products']")
...
@FindBy(xpath="//textarea[@id='input_textarea2']")
WebElement input_textarea2;
...
public void compare_product() throws Exception {
driver.manage().timeouts().implicitlyWait(20,TimeUnit.SECONDS);
	...
	input_textarea2.sendKeys("iPhone 15 pro max high demand in india ");
	tab_text.click();
