...
public class Title_generator_Page {
	WebDriver driver;
	public Title_generator_Page(WebDriver driver) {
		this.driver=driver;
	...
	@FindBy(xpath="//a[@href='/title-generator']")
	WebElement title_generator;
	...
	public void title_gen() throws Exception {
