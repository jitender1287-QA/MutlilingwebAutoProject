...
public class summary_generator_Page {
WebDriver driver;
public summary_generator_Page(WebDriver driver) {
	this.driver=driver;
...
@FindBy(xpath="//a[@href='/summary-generator']")
WebElement summary_generator;
...
public void summary_generator_check() throws Exception {
