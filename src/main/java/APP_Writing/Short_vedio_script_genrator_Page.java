...
public class Short_vedio_script_genrator_Page {
WebDriver driver;
public Short_vedio_script_genrator_Page(WebDriver driver) {
...
@FindBy(xpath="//a[@href='/script-generator']")
WebElement script_generator;
@FindBy(xpath="//select[@id='movie_type']")
WebElement movie_type;
...
public void shrot_vedio_script() throws Exception {
...
driver.manage().timeouts().implicitlyWait(20,TimeUnit.SECONDS);
	...
	script_generator.click();
	Select sel0= new Select(movie_type);
	sel0.selectByVisibleText("Drama");
	
	input_textarea.sendKeys("going in hill and listin roumemrs in this hill night having ghost ound cry for 10 minn in means time no one can go outside");
	tab_text.click();
