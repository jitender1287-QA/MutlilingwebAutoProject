...
public class Press_release_Page {
WebDriver driver;
public Press_release_Page(WebDriver driver) {
	this.driver=driver;
...
@FindBy(xpath="//a[contains(@href,'/press-release')]")
WebElement Press_release_Page;
...
public void Press_release_genrator() throws Exception {
