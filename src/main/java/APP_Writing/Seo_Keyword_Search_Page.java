...
public class Seo_Keyword_Search_Page {
WebDriver driver;
public Seo_Keyword_Search_Page(WebDriver driver) {
	this.driver=driver;
...
@FindBy(xpath="//a[@href='/keywords-generator']")
WebElement keywords_generator;
...
public void Seo_keyword() throws Exception {
