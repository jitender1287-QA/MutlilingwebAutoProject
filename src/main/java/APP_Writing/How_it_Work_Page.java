...
public class How_it_Work_Page {
WebDriver driver;
public How_it_Work_Page(WebDriver driver) {
	this.driver=driver;
...
@FindBy(xpath="//a[contains(@href,'/how-it-works')]")
WebElement how_it_works;
...
public void How_t_work() throws Exception {
