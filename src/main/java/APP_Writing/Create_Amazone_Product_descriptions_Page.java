...
public class Create_Amazone_Product_descriptions_Page {
WebDriver driver;
public Create_Amazone_Product_descriptions_Page(WebDriver driver) {
	this.driver=driver;
...
@FindBy(xpath="//a[@href='/amazon-product-description']")
...
public void Amazone_description() throws Exception {
driver.manage().timeouts().implicitlyWait(20,TimeUnit.SECONDS);
	...
	input_textarea.sendKeys("selling player kit with budget price so hit the count on product");
	tab_text.click();
