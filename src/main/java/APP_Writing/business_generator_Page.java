...
public class business_generator_Page {
WebDriver driver;
public business_generator_Page(WebDriver driver) {
	this.driver=driver;
...
@FindBy(xpath="//a[@href='/business-generator']")
WebElement business_generator;
@FindBy(xpath="//select[@id='name_type']")
WebElement name_type;
...
public void business_generator() throws Exception {
	...
	business_generator.click();
	Select de= new Select(name_type);
	de.selectByVisibleText(tex);
