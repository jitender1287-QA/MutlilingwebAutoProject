...
public class Paragraph_genrator_Page {
WebDriver driver;

public Paragraph_genrator_Page(WebDriver driver) {
	this.driver=driver;
...
@FindBy(xpath="//a[@href='/paragraph-generator']")
WebElement paragraph_generator;
...
public void paragraph_checking() throws Exception {
	driver.manage().timeouts().implicitlyWait(20,TimeUnit.SECONDS);
	
	Writing.click();
	String tex=Writing_Assistant.getText();
	System.out.println(tex);
	paragraph_generator.click();
