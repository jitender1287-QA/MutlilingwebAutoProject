...
public class product_description_Page {
	...
	@FindBy(xpath="//a[contains(@href,'/product-description')]")
	...
	/*
	 * @FindBy(id="result_textarea_ifr") WebElement frame1;
	 */
	@FindBy(xpath="//textarea[@class='writing-result-output font-18 auto-resize mb-2']")
	WebElement gettext;

	public void product_description_function() throws Exception {
