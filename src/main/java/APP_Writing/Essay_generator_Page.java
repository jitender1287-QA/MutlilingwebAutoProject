...
public class Essay_generator_Page {
	WebDriver driver;
	public Essay_generator_Page(WebDriver driver) {
		this.driver=driver;
	...
	@FindBy(xpath="//a[contains(@href,'/essay-generator')]")
	WebElement essay_generator;
	...
	public void Essay_checkne() throws Exception {
