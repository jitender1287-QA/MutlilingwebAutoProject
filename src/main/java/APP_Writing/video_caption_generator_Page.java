...
public class video_caption_generator_Page {
WebDriver driver;
public video_caption_generator_Page(WebDriver driver) {
...
@FindBy(xpath="//a[@href='/video-caption-generator']")
WebElement video_caption_generator;
...
public void vedio_caption() throws Exception {
...
driver.manage().timeouts().implicitlyWait(20,TimeUnit.SECONDS);
	...
	video_caption_generator.click();
	Select se0= new Select(platform);
	se0.selectByVisibleText("YouTube Short");
