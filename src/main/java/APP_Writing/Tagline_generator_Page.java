...
public class Tagline_generator_Page {
	WebDriver driver;
	public Tagline_generator_Page(WebDriver driver) {
		this.driver=driver;
	...
	@FindBy(xpath="//a[@href='/tagline-generator']")
	WebElement tagline_generator;
	...
	WebElement gettext;
	public void tagline() throws Exception {
		driver.manage().timeouts().implicitlyWait(20,TimeUnit.SECONDS);
		
		Writing.click();
		String tex=Writing_Assistant.getText();
		System.out.println(tex);
		tagline_generator.click();
