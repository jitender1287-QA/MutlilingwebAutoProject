...
public class Journal_Article_Checker_IEEE_Page {
WebDriver driver;
 public Journal_Article_Checker_IEEE_Page(WebDriver driver) {
this.driver=driver;
PageFactory.initElements(driver,this);
 ...
 public void jouranal_checking_IEEE() {
 	
 	driver.manage().timeouts().implicitlyWait(20,TimeUnit.SECONDS);
 	Citation.click();
 	Journal_article.click();
 	search_journal.sendKeys("https://www.bizspice.com/");
 	Select sel= new Select(journal_type);
 	sel.selectByVisibleText("IEEE");
 	submit.click();
 }
