...
import APP_URL.URL;
import APP_Writing.Create_Amazone_Product_descriptions_Page;
import BaseTest_Multilings.BaseClass;
import Login_Page_Object.Login_PAge;
import Login_Page_Object.Login_Succesfully_Form;

public class Create_Amazone_Product_descriptions_Test extends BaseClass{
	...
	public void Test_How_To_works() throws Exception {
		Create_Amazone_Product_descriptions_Page create_description= new Create_Amazone_Product_descriptions_Page(driver);
		create_description.Amazone_description();
	}
}
