...
public class HashTag_Genrator_Test extends BaseClass{
	...
	@Test(priority=4)
	public void Test_Hashtag_genrator() throws Exception {
		HashTag_Genrator_Page hashtag_code=new HashTag_Genrator_Page(driver);
		hashtag_code.hagtag_genrator();
	}
}
