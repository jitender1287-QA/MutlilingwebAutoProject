...
public class Story_generator_Test extends BaseClass{
	...
	@Test(priority=4)
	public void Test_Story_generator_Page() throws Exception {
		Story_generator_Page story_checking = new Story_generator_Page(driver);
		story_checking.story_genrator();
	}
}
