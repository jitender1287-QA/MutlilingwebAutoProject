...
public class Compare_Product_Service_Test extends BaseClass{
	...
	public void Test_How_To_works() throws Exception {
		Compare_Product_Service_Page compare_pro= new Compare_Product_Service_Page(driver);
		
		compare_pro.compare_product();
	}
}
