...
public class Marketing_Ideas_Test extends BaseClass{
	...
	@Test(priority=4)
	public void Test_Market_idea() throws Exception {
		
		Marketing_Ideas_Page market_idea= new Marketing_Ideas_Page(driver);
