...
@Test(priority=1)
	...
	@Test(priority=4)
	public void Test_Meme_genrator() throws Exception {
		Tagline_generator_Page tageline= new Tagline_generator_Page(driver);
		tageline.tagline();
	}
}
