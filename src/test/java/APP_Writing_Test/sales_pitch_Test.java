...
public class sales_pitch_Test extends BaseClass{
	...
	public void Test_sales_pitch() throws Exception {
		sales_pitch_Page sales_pitch_f=new sales_pitch_Page(driver);
		sales_pitch_f.sales_pitch_function();
	}
}
