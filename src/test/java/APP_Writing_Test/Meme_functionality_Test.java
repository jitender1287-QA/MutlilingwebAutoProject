...
public class Meme_functionality_Test extends BaseClass {
	...
	public void Test_Meme_genrator() throws Exception {
		Meme_functionality_Page mems= new Meme_functionality_Page(driver);
		mems.Meme_genrator();
	}
}
