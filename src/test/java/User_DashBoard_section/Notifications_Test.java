...
import User_DashBoard.Notifications_Page;

public class Notifications_Test extends BaseClass{
	@Test(priority=1)
	...
	@Test(priority=5)
	public void Test_Notifications_Page() throws Exception {
		Notifications_Page notification = new Notifications_Page(driver);
		notification.notifiction_table();
	}
}
