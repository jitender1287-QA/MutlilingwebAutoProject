...
import User_DashBoard.Subscriptions_Update_Page;

public class Subscriptions_Update_Page_Test extends BaseClass{
	@Test(priority=1)
	...
	@Test(priority=5)
	public void Test_Subscriptions_Update_Page() throws Exception {
		Subscriptions_Update_Page update_subscirtion= new Subscriptions_Update_Page(driver);
				update_subscirtion.subscription_plan();	
	}
}
