...
import User_DashBoard.Team_Members_Page;

public class Team_Members_Test extends BaseClass{
	@Test(priority=1)
	...
	@Test(priority=5)
	public void Test_Team_Members_Page() throws Exception {
		Team_Members_Page member_info= new Team_Members_Page(driver);
		member_info.Team_Memeber_ststus();
	}
