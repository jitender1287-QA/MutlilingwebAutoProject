...
import User_DashBoard.User_Billing_Page;

public class User_Billing_Test extends BaseClass{
	@Test(priority=1)
	...
	@Test(priority=5)
	public void Test_User_Billing_Page() throws Exception {
		User_Billing_Page Billing_info= new User_Billing_Page(driver);
		Billing_info.user_billing_detail();
	}
}
