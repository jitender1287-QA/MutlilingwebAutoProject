...
public class Created_Project_Check_Test extends BaseClass{
	@Test(priority=1)
	...
	@Test(priority=4)
	public void Test_Created_Project_Check_Page() throws Exception {
		Created_Project_Check_Page Projects= new Created_Project_Check_Page(driver);
