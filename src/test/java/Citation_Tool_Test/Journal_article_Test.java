...
import Citation_Tool.Journal_article_Page;
import Login_Page_Object.Login_PAge;
import Login_Page_Object.Login_Succesfully_Form;

public class Journal_article_Test extends BaseClass{
	@Test(priority=1)
	...
	@Test(priority=4)
	public void Test_Journal_article_Page() throws Exception {

		Journal_article_Page cheking_journal= new Journal_article_Page(driver);
		cheking_journal.jouranal_checking();
	}
}