...
public class Translate_Website_Test extends BaseClass {
	...
	@Test(priority=4)
	public void Test_Translate_Website_Page() throws Exception {
		Translate_Website_Page withfile_website= new Translate_Website_Page(driver);
		withfile_website.website_translate();
	}
}
