...
public class Translate_Checking_Test extends BaseClass{
	@Test(priority=1)
	...
	@Test(priority=4)
	public void Test_Translate_Page() throws Exception {
		Translate_Page translate_checking= new Translate_Page(driver);
		translate_checking.translate_checking();
	}
}
