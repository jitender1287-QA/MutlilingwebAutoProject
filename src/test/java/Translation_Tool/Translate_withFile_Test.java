...
public class Translate_withFile_Test extends BaseClass{
	@Test(priority=1)
	...
	@Test(priority=4)
	public void Test_Translate_withFile_Page() throws Exception {
		Translate_withFile_Page withfile= new Translate_withFile_Page(driver);
		withfile.Translate_pdf();
	}
}
