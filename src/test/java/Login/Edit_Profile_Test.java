...
import Login_Page_Object.Edit_Profile_Page;
import Login_Page_Object.Login_PAge;
import Login_Page_Object.Login_Succesfully_Form;

public class Edit_Profile_Test extends BaseClass{
	...
	@Test(priority=5)
	public void Test_Edit_Profile_Page() throws Exception {
		Edit_Profile_Page edit_user_info =new Edit_Profile_Page(driver);
		edit_user_info.Edit_profile_user();	
	}
