...
import Plagiarism_Checker.Plagiarism_Page;

public class Plagiarism_Test extends BaseClass{
	...
	@Test(priority=4)
	public void Test_Plagiarism_Page() throws Exception {
		Plagiarism_Page plag= new Plagiarism_Page(driver);
		plag.PLag_checker();
	}
}
